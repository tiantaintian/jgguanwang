...
(function() {
  ...
  hm.src = "https://hm.baidu.com/hm.js?c54529c0d422d0e4e11e1dc6261ea5cd";
...
//字符串转化为时间
String.prototype.toDate = function (date) { return new Date(date.replace(/-/g, "/")); }
/*时间格式化*/
String.prototype.toDate = function () { return new Date(this.replace(RegExp("-", "g"), "/")); }
